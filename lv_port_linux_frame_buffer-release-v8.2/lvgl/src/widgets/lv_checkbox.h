...
/**
 * 创建一个复选框对象Create a check box object
...
/**
 * 设置复选框的文本内容 Set the text of a check box. `txt` will be copied and may be deallocated
...
/**
 * 获取复选框对象的文本内容Get the text of a check box
